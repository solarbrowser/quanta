...
#include "quanta/core/runtime/Types.h"
#include <string>
#include <memory>
#include <cstdint>
#include <cmath>
 ...
 * for 64-bit systems with pointer tagging
 */
class Value {
public:
...
private:
    ...
    static uint64_t compress_pointer(void* ptr) {
        ...
        if (heap_base_ == 0) {
            ...
            if (heap_base_ == 0) heap_base_ = addr & ~0xFFFFFFFFULL;
        }
    ...
    static constexpr uint64_t QUIET_NAN     = 0x7FF0000000000000ULL;
    static constexpr uint64_t TAG_MASK      = 0x000F000000000000ULL;
    static constexpr uint64_t PAYLOAD_MASK  = 0x0000FFFFFFFFFFFFULL;
    
    static constexpr uint64_t TAG_UNDEFINED = 0x0000000000000000ULL;
    ...
    static constexpr uint64_t TAG_SYMBOL    = 0x0005000000000000ULL;
    static constexpr uint64_t TAG_BIGINT    = 0x0006000000000000ULL;
    static constexpr uint64_t TAG_OBJECT    = 0x0007000000000000ULL;
...
public:
    ...
    bool same_value(const Value& other) const;
