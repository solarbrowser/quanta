...
public:
    // WASM Section IDs (WebAssembly spec)
...
class WasmVM {
public:
    // WASM instruction opcodes (core set)
    ...
    struct ExecutionFrame {
        ...
        const uint8_t* end; // End of function bytecode
    };
