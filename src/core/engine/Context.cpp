...
Context::Context(Engine* engine, Context* parent, Type type)
    : type_(type), state_(State::Running), context_id_(next_context_id_++),
      ...
      is_in_constructor_call_(false), super_called_(false), this_needs_super_(false), original_this_was_nullish_(false), strict_mode_(parent && type != Type::Function ? parent->strict_mode_ : false),
